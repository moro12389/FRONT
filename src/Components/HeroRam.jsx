...
const Hero = () => {
    ...
    useEffect(() => {
        ...
        const obtenerProductos = async () => {
            await fetch('https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/obtenerProductos', {
                method: "GET",
                credentials: 'include',
                mode: 'cors',
            })
    ...
    useEffect(() => {
        fetch('https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/obtenerOfertas', {mode: 'cors'})
            .then(response => {
                if (!response.ok) {
                    throw new Error('no se conecto');
                }
