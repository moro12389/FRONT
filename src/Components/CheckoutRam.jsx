...
const Checkout = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/userId"
        ...
        const fetchData1 = async () => {
            try {
                const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/obtenerCarrito/"
        ...
        const fetchData2 = async () => {
            try {
                const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/registerUser_getOne/"
                const response = await fetch(`${URL}${usuarioId}`, {
                    method: "GET",
                    credentials: 'include',
                    mode: 'cors',
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/obtenerProductos"
                const response = await fetch(`${URL}`, {
                    method: "GET",
                    credentials: 'include',
                    mode: 'cors',
    ...
    useEffect(() => {
        fetch('https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/obtenerCupones', {
            method: "GET",
            credentials: 'include',
            mode: 'cors',
        })
    ...
    const eliminaCarrito = async () => {
        try {
            const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/eliminarCarritoUser/" // Reemplaza con la ruta correcta
            const response = await fetch(URL, {
                method: "DELETE",
                credentials: "include",
                mode: 'cors',
    ...
    const insertaCupon = async () => {
        try {
            const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/agregarCuponUsado"
    ...
    const quitarStock = async () => {
        ...
        const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/actualizarRestarStockProducto"
        try {
            const response = await fetch(`${URL}`, {
                method: "PATCH",
                credentials: 'include',
    ...
    const guardaDatosProductoComprado = async () => {
        ...
        try {
            const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/finalizarCompra"
    ...
    const enviarFormulario = async () => {
        ...
        try {
            const response = await fetch('https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/registerUser_add', {
                method: 'POST',
                mode: 'cors',
                headers: {
                    'Content-Type': 'application/json',
