...
const Register = () => {
  ...
  const register = async () => {
    ...
    if (access) {
      ...
      try {
        const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/registerUser_add"; // Reemplaza con la ruta correcta
  ...
  const existe = async () => {
    ...
    try {
      const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/register_getEmail/";
