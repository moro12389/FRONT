...
const BagDropdown = () => {
  ...
  const handleQuantityChange = async (index, newQuantity, basePrice, id, operation) => {
    ...
    try {
      const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/actualizarCarrito"; // Reemplaza con la ruta correcta
      const response = await fetch(URL, {
        method: "PATCH",
        credentials: "include",
        mode: 'cors',
  ...
  const eliminarDeCarrito = async (index, id) => {
    try {
      const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/eliminarCarritoUserProducto/"; // Reemplaza con la ruta correcta
      const response = await fetch(URL, {
        method: "DELETE",
        credentials: "include",
        mode: 'cors',
