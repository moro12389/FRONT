...
const Submenu = () => {
  ...
  const handleBotonClick = async (key, productoId, usuarioId, quantity) => {
    ...
    try {
      ...
      const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/cargarCarrito";
      const response = await fetch(URL, {
        method: "POST",
        mode: 'cors',
        headers: {
  ...
  useEffect(() => {
    ...
    const fetchData = async (cat) => {
      try {
        const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/obtenerProductosCategoria/"
  ...
  useEffect(() => {
    const fetchCategoria = async (cat) => {
      try {
        const URL = "https://nodejs-serverless-function-express-one-opal.vercel.app/api/menu/obtenerCategoria/"
